...
<div class="Acceuil">
  <div class="container">
          ...
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1"><img src="Images\fievre-chien-fievre-chat.jpg" width="150" height="150"/> <h2>vet 1</h2> prix unitaire : 15,00€ TTC</button>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title"> vet 1 </h4>
                </div>
                <div class="modal-body">
                  <div class="media-left media-top">
                    <img src="Images\fievre-chien-fievre-chat.jpg" width="150" height="150"/>
                  </div>
      ...
      <br/><br/>
        ...
        <div class="container">
          <p>Cliquez sur le produit pour consulter sa description</p>
          <!-- Trigger the modal with a button -->
          <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2"><img src="Images\fievre-chien-fievre-chat.jpg" width="150" height="150"/> <h2>vet 2</h2> prix unitaire : 10,00€ TTC</button>
